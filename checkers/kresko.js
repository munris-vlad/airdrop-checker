...
async function checkAirdrop(wallet, proxy = null) {
    ...
    while (!isFetched) {
        await axios.post(`https://check.kresko.link/`, [wallet.toLowerCase()], config).then(async response => {
            ...
            stats[wallet].airdrop = result[1][0] ? parseInt(result[1][0].points) : 0
...
async function fetchWallets() {
    ...
    const csvFilePath = './results/kresko.csv'
...
export async function kreskoAirdropChecker() {
