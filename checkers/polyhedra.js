...
let p
let csvWriter
let wallets = readWallets('./addresses/polyhedra.txt')
...
async function checkAirdrop(wallet, proxy = null) {
    ...
    let addrPrefix = wallet.toLowerCase().substring(2, 5)
...
export async function polyhedraAirdropChecker() {
