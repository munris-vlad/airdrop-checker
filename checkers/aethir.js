...
async function checkAirdrop(wallet, proxy = null) {
    ...
    while (!isFetched) {
        await axios.get(`https://claims.aethir.com/clique-aethir-api/campaign/aethir/credentials?walletAddress=${wallet}`, config).then(async response => {
            stats[wallet].airdrop = parseInt(response.data.data.pipelines.tokenQualified)
...
async function fetchWallets() {
    ...
    const csvFilePath = './results/aethir.csv'
...
export async function aethirAirdropChecker() {
