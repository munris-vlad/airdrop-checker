...
async function checkAirdrop(wallet, proxy = null) {
    ...
    while (!isFetched) {
        await axios.get(`https://trailblazer.mainnet.taiko.xyz/s2/claim/proof?address=${wallet}`, config).then(async response => {
...
export async function taikoAirdropChecker() {
