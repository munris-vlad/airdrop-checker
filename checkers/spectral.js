...
async function checkAirdrop(wallet, proxy = null) {
    ...
    while (!isFetched) {
        await axios.get(`https://airdrop-api.dev.spectrallabs.xyz/getNonReclaimMerkleProofAndAllocation/${wallet}`, config).then(async response => {
...
export async function spectralAirdropChecker() {
